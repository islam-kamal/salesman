...
import 'package:water/widgets/finish_button_invoices_details_screen.dart';
...
import 'package:water/widgets/trader_deal_invoices_details_screen.dart';
            ...
            children: [
              Expanded(
                ...
                child: Column(
                  ...
                  const TraderDealInvoicesDetailsScreen(),
                  SizedBox(
                    height: MediaQuery.of(context).size.height * 0.025,
                  ),
                  const FinishButtonInvoicesDetailsScreen(),
                ],
              )),
