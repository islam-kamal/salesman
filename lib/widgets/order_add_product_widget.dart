                  ...
                  child: Row(
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          setState(() {
                            if(selectedProductCount! < int.parse(widget.product!.count! ))
                      ...
                      children: [
                        Row(
                          ...
                          width: MediaQuery.of(context).size.width * 0.005,
                                   ...
                                   Text(
                                    'متبقى   ${int.parse(widget.product!.count! )- selectedProductCount!}  قطعة',
                                    style: TextStyle(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w500
                                    ),
                    ...
                    GestureDetector(
                      onTap: () {
                        if( Shared.order_products_list.where((element) => element.id ==
                            widget.product!.id).toList(growable: true).length == 0){
