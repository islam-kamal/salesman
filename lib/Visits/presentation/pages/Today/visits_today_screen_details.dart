                        ...
                        child: Row(
                          ...
                          children: [
                            TransactionDetailsContainer(
                              ...
                              color: Color(0xff0056C9),
                              name: 'مبيعات',
                              price: '${state.visitDetails![0].totalSales!}  ر.س ',
                            ),
                            TransactionDetailsContainer(
                              image: 'assets/images/Union.png',
                              color: Color(0xFFAC6521),
                              name: 'مرتجعات',
                              price: '${state.visitDetails![0].totalRefund!}  ر.س ',
                            ),
                            TransactionDetailsContainer(
                              image: 'assets/images/moneyBaggg.png',
                              color: Color(0xff1D6E4F),
                              name: 'تحصيل',
                              price: '${state.visitDetails![0].totalPayment!}  ر.س '
                            ),
                            TransactionDetailsContainer(
                              image: 'assets/images/DangerTriangle.png',
                              color: Color(0xffAF2A1A),
                              name: 'مديونية',
                              price:'${state.visitDetails![0].totalAmountDue!}  ر.س '
                            ),
                          ],
                        ),
                      ),
